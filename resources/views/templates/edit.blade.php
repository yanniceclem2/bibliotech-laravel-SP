...
<div class="container mt-4">
    ...
    <div class="card">
        <div class="card-body">
            {{-- TODO: Formulaire avec méthode PUT vers route update --}}
            <form action="#" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" 
                           ...
                           id="champ1" 
                           name="champ1" 
                           value="{{ old('champ1', 'valeur_actuelle') }}"
                           required>
                    @error('champ1')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" 
                           ...
                           id="champ2" 
                           name="champ2" 
                           value="{{ old('champ2', 'valeur_actuelle') }}">
                    @error('champ2')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
    ...
    {{-- TODO: Ajouter un formulaire de suppression séparé si nécessaire --}}
</div>
@endsection
